...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[] {
        ...
        if(locationCursor.moveToNext()) {
            ...
            Uri returnUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Log.d("FetchWeatherTask", "INSERTED: " + locationId);
